export const projects = [
  ...
  },
  {
    ...
    languages: "Built with React & Styled Components.",
  ...
  },
  {
    ...
    description:
      "Gavel is an online auction site. The API functionality is managed by an existing application, and the project only covers the front-end application for the API.",
    languages: "Built with JavaScript, HTML & SCSS.",
